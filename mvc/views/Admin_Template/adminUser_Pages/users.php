...
<a href="http://localhost/duan1_Nhom12_WD18202/admin/admin_users/insertTheme"><button type="button" id="deselect-all" class="btn btn-success">Thêm khách hàng</button></a>
    ...
    <table class="table text-center">
        ...
        <?php foreach ($data['table'] as $user) { ?>
            <tr>
                ...
                <a href="http://localhost/duan1_Nhom12_WD18202/admin/admin_users/deleteFeatureById/<?= $user['id'] ?>" onclick="return confirm('Bạn có muốn xóa không?')" type="button" class="btn btn-danger">Delete</a>
                </td>
            </tr>
        <?php } ?>
    </table>
