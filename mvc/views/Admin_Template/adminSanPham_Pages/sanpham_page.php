            ...
            <div class="col-md-6">
                <form action="http://localhost/duan1_Nhom12_WD18202/admin/admin_sanpham/Theme" method="get">
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" value="<?php if(isset($_GET['search'])){ echo $_GET['search']; } ?>" name="search" style="flex: none; width: 300px; margin-left: 5px;" placeholder="" aria-label="" aria-describedby="basic-addon1">
                    </div>
                </form>
            </div>
            <div class="col-md-6">
