...
<a href="http://localhost/duan1_Nhom12_WD18202/admin/admin_danhmuc/delDM_byCheckBox"><button id="deleteAllBtn" class="btn btn-secondary" name="btn_delByCheckBox" onclick="return confirm('Bạn có chắc chắn muốn xóa dữ liệu?')">Xóa Tất Cả</button></a>
